...
class ServiceRegistryMS:
    ...
    def scan(self, save_to: Optional[str] = OUTPUT_FILE) -> List[Dict[str, Any]]:
        ...
        # 2. Save Registry (Defensive Check)
        # CRITICAL FIX: Only try to save if save_to is a valid string
